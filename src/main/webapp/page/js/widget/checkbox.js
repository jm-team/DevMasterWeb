jmCheckbox = (function() {
    return {
        name : '复选框',
        type : 'checkbox',
        htmlSnippet : '<input type="checkbox" id="${id}" name="${name}" value="${value}" class="${clazz}" data-widget-id="${widgetId}" data-widget-type="jmCheckbox" />',
        attributes : [ {
            name : 'id',
            value : 'id',
            ...
            name : 'checked',
            value : 'checked',
            description : 'the checked of the checkbox'
        } ],
